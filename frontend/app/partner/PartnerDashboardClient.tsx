    ...
    <main className="min-h-screen bg-[#f6f8fb] text-slate-950">
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          {!partner.is_active && (
            <div className="mt-6 bg-orange-50 border border-orange-200 rounded-3xl p-5">
              <p className="font-semibold text-orange-800">
                ⏳ Validation en cours
              </p>
              <p className="text-sm text-orange-700 mt-2 leading-6">
                Votre profil est bien créé mais doit encore être validé par
                Paulo. Vous pouvez consulter votre espace, mais vous ne recevrez
